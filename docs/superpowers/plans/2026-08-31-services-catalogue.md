...
| `app/(app)/services/**` | List, new, detail screens + actions |
...
**Files:**
- Create: `app/(app)/services/page.tsx`
- Create: `app/(app)/services/actions.ts`
- Create: `app/(app)/services/new/page.tsx`
- Create: `app/(app)/services/new/service-form.tsx`
...
Read `app/(app)/staff/page.tsx` and `app/(app)/staff/new/` first and follow those patterns exactly.
...
```bash
git add "app/(app)/services" scripts/service-check.mjs
...
**Files:**
- Create: `app/(app)/services/[id]/page.tsx`
- Create: `app/(app)/services/[id]/service-detail-forms.tsx`
- Modify: `app/(app)/services/actions.ts`
...
Guarded by `service: ['update']`, loading via `getService(serviceId, organizationId)` — org-scoped in the query — and 404ing when null. Mirror `app/(app)/staff/[id]/` in layout: separate cards per operation.
...
**Files:**
- Modify: `app/(app)/services/[id]/page.tsx`, `service-detail-forms.tsx`, `app/(app)/services/actions.ts`
...
```bash
git add "app/(app)/services" lib/service.ts scripts/service-check.mjs
...
- Modify: `app/(app)/services/page.tsx`, `app/(app)/services/actions.ts`
...
```bash
git add app/onboarding "app/(app)/services" scripts/service-check.mjs
